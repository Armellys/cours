...
if (cle != NULL) { //phase de génération des sous clefs
   ...
   *************************************************************/
   ...
   permute(temp, Des_Transform, 56);//permutation initiale des clefs
   ...
   *************************************************************/
   ...
   for (i = 0; i < 16; i++) {
      ...
      **********************************************************/
      ...
      //TODO rotation a gauche de la clŽ de droite
	...
	for (j = 0; j < 28; j++){
		...
		//TODO mme chose pour la clŽ de droite
